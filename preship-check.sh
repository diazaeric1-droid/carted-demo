...
grep -q 'const APP_V="98", BUILD_COHORT="build7"' index.html || say "analytics APP_V/cohort is not Build 7 release v98"
grep -q 'const CACHE = "carted-v98"' sw.js || say "service-worker cache is not Build 7 release v98"
